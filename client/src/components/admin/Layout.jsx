        ...
        <div className="h-full flex flex-col justify-between">
          <div>
            ...
            <li>
              ...
              <li>
                <a href="/diary" className="block py-2 px-4 text-gray-700 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Diaries</a>
              </li>
              <li>
                <a href="/diary" className="block py-2 px-4 text-gray-700 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Egg List</a>
              </li>
              <li>

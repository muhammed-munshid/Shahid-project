        ...
        <div className="h-full flex flex-col justify-between">
          <div>
            ...
            <ul className="space-y-2 p-4">
              <li>
                <a href="/" className="block py-2 px-4 text-gray-700 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Users</a>
              </li>
              {/* Add more links here */}
            </ul>
          </div>
          <div className="p-4">
            <button className="block w-full py-2 px-4 text-left text-gray-700 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">Logout</button>
          </div>
        </div>
      </div>
